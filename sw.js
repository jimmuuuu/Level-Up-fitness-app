const CACHE = 'level-up-fitness-20260817-account-switching-v1';
const CORE = [
  ...
  './authoritative-history-sync.js', './auth-session-fix.js',
...
const SHELL = CORE.slice(0, 32);
const ASSETS = CORE.slice(32);
