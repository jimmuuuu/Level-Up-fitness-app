const CACHE = 'level-up-fitness-20260817-weekly-review-v1';
const CORE = [
  ...
  './weekly-workout-review.css', './weekly-workout-review.js',
...
const SHELL = CORE.slice(0, 17);
const ASSETS = CORE.slice(17);
