const CACHE = 'level-up-fitness-20260819-companion-suite-v16';
const CORE = [
  ...
  './companion-quality.css', './companion-quality.js',
...
const SHELL = CORE.slice(0, 79);
const ASSETS = CORE.slice(79);
